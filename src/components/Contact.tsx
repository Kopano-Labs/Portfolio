...
import { Send, ArrowUpRight, Github, Linkedin, Mail, Heart, Coffee } from "lucide-react";
    ...
    <section id="contact" className="py-24 sm:py-32 relative">
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="relative p-10 sm:p-16 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[#060d18] text-white font-semibold text-sm hover:scale-105 transition-transform shadow-lg"
              >
                <Github size={16} />
                View GitHub
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          >
            <h3 className="text-2xl font-bold mb-2 text-white">Connect With Me</h3>
            <p className="text-sm text-gray-500 mb-8">
            ...
            <div className="space-y-3 mb-10">
              {socials.map((s) => (
                ...
                >
                  ...
                  <ArrowUpRight size={14} className="ml-auto text-gray-600 group-hover:text-[#00e89d] transition-colors" />
                </a>
              ))}
            </div>
            ...
            <div className="rounded-xl border border-[#1a2744] bg-[#0f1a30]/30 p-6">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h4 className="text-sm font-bold text-white">Support My Work</h4>
              </div>
