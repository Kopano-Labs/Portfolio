...
export default function Story() {
  ...
  return (
    <section className="relative py-20 sm:py-24 overflow-hidden">
      ...
      <div
        className="relative max-w-5xl mx-auto px-12 sm:px-20 lg:px-36"
        ref={ref}
      >
        {/* Header */}
        <motion.div
        ...
        >
          ...
          <p className="text-gray-300 text-base sm:text-lg leading-relaxed mb-6 max-w-2xl">
            My journey into tech started with a simple question — how do
            websites work? That curiosity led me from HTML basics to mastering
            the full MERN stack. Today, as a Computer Engineering student and
  ...
  return (
    ...
    >
      ...
      {status?.connected && posts.length > 0 && (
        ...
        >
          <a
          <a // Changed to LinkedIn profile link
