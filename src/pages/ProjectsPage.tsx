    ...
    <main className="brand-page overflow-hidden pb-24 pt-28">
      ...
      <section className="py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-12">
          ...
          <div className="mt-10 rounded-[22px] border border-[rgba(208,133,77,0.18)] bg-[rgba(208,133,77,0.08)] p-6">
            <p className="brand-kicker">Creative Ecosystem</p>
            <h3 className="mt-3 text-2xl font-semibold tracking-[-0.04em] text-[var(--brand-text)]">
              Ama-Phu Entertainment now has its own evidence page.
            </h3>
            <p className="mt-4 max-w-3xl text-sm leading-7 text-[var(--brand-soft-text)]">
              The entertainment side used to be compressed into one line beside the venue work. It
              now has a separate page so the label hub, creator routing, and 5&apos;s Arena product
              crossover can be inspected without mixing them into unrelated project cards.
            </p>
            <div className="mt-6">
              <Link
                to="/ama-phu-entertainment"
                className="inline-flex items-center gap-2 rounded-[10px] border border-[rgba(208,133,77,0.24)] px-4 py-2.5 text-sm font-semibold text-[var(--brand-text)] transition-colors hover:bg-[rgba(208,133,77,0.12)]"
              >
                Open Ama-Phu page
