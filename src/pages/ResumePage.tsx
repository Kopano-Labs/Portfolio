...
const experience = [
  ...
  },
  {
    ...
    period: "2023 — Present",
    bullets: [
      "Delivered the Bookit 5's Arena booking platform as a real product surface instead of a brochure site",
      "Worked across the wider Ama-Phu client ecosystem, connecting entertainment-facing profile surfaces with venue and web product delivery",
      "Shipped supporting web properties including the 5's Arena blog and public portfolio builds",
          ...
          <div className="p-8 sm:p-12 lg:p-16">
            ...
            >
              ...
              <p className="max-w-2xl text-sm leading-relaxed text-gray-300">
                ...
                infrastructure, resilient full-stack product systems, and public-facing client delivery across
                both studio and Ama-Phu ecosystem work.
              </p>
            </motion.section>
